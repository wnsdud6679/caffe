...
Classifier::Classifier(const string& model_file,
 ...
 // SetMean(mean_file);
  avgimg = cv::Mat( input_geometry_, CV_32FC3, cv::Scalar(93.5940,104.7624,129.1863));//change
  /* Load labels. */
...
void Classifier::Preprocess(const cv::Mat& img,
  ...
  cv::subtract(sample_float, avgimg, sample_normalized);//change
